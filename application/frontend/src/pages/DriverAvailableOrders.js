      ...
      <div className = "order_header h3 text-white text-center py-2">Assigned Orders</div>
        ...
        <tbody>
          <tr>
            ...
            <td className = "border border_body"><button type = "button" className = "btn btn-warning btn-sm border border_header" data-toggle = "modal" data-target = "#viewOrder1">View</button></td>
          </tr>
          ...
          <tr>
            ...
            <td className = "border border_body"><button type = "button" className = "btn btn-warning btn-sm border border_header" data-toggle = "modal" data-target = "#viewOrder2">View</button></td>
          </tr>
          ...
          <tr>
            ...
            <td className = "border border_body"><button type = "button" className = "btn btn-warning btn-sm border border_header" data-toggle = "modal" data-target = "#viewOrder3">View</button></td>
          </tr>
        </tbody>
        </table>
      
        {/* View order 1 */}
        <div class="modal fade" id="viewOrder1" tabindex="-1" role="dialog" aria-labelledby="viewOrderTitle" aria-hidden="true">
        ...
        {/* View order 2 */}
        <div class="modal fade" id="viewOrder2" tabindex="-1" role="dialog" aria-labelledby="viewOrderTitle" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="viewOrderTitle">Order Details</h5>
        ...
        {/* View order 3 */}
        <div class="modal fade" id="viewOrder3" tabindex="-1" role="dialog" aria-labelledby="viewOrderTitle" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="viewOrderTitle">Order Details</h5>
