      ...
      <div className="about-body container-fluid">
        ...
        <div className="container">
          ...
          <div className="d-flex justify-content-around row text-center flex-wrap mt-3">
            <div className="about-projects card col-sm-6 col-lg-4 py-2 m-1">
              <h4 className="about-skill-name">
               <a className = "project-links" href = "https://github.com/henzonz/Super-Rainbow-Reef-Game"> <strong>Super Rainbow Reef Game</strong> </a>
              </h4>
              ...
              <img className = "img-fluid card-img-bottom" src = {RainbowReef} width = "150" height = "150" alt = ""/>
            </div>
            <div className="about-projects card col-sm-6 col-lg-4 py-2 m-1">
              <h4 className="about-skill-name">
               <a className = "project-links" href = "https://github.com/henzonz/Calculator-GUI-asmt-"> <strong>Calculator</strong> </a>
              </h4>
              ...
              <img className = "img-fluid card-img-bottom" src = {Calculator} width = "150" height = "150" alt = ""/>
            </div>

            <div className="about-projects card col-sm-6 col-lg-4 py-2 m-1">
              <h4 className="about-skill-name">
               <a className = "project-links text-decoration-none" href = "https://sites.google.com/view/fitapp-repcounter/design?authuser=0"> <strong>Hercules App</strong> </a>
              </h4>

              <blockquote className="project-desc card-body bg-light font-italic">
              ...
              <img className = "img-fluid card-img-bottom" src = {Hercules} width = "150" height = "150" alt = ""/>
            </div>
          </div>
        </div>
      </div>
