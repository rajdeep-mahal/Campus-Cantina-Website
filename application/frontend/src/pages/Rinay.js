...
import Chainz from '../assets/img/rinay/2chainz.gif';
...
const Rinay = () => {
  return (
    <div>
      ...
      <div class="card">
        <div
          class="card-body text-center justify-content-center align-self-center header-card"
        >
          <img
            ...
            <div>
              ...
              <div class="edu-info" style={{textAlign: 'left'}}>
                ...
                <p class="text-left proj-p">
                  ...
                  the backend, and with Node.js and React.js for the
                  frontend.<br />
                </p>
              </div>
            </div>
            ...
            <div class="edu-info" style={{textAlign: 'left'}}>
              <p class="text-left proj-p">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  >github.com/rinaykumar/word-blast</a
                >
              </p>
              <p class="text-left year">2020</p>
              <p class="text-left proj-p">
    ...
    <section
      class="text-center d-flex d-sm-flex justify-content-center align-self-center justify-content-sm-center justify-content-md-center justify-content-lg-center"
    >
      <div
        class="text-center d-flex justify-content-lg-center align-items-lg-center"
        id="projects-display"
      >
        <div
