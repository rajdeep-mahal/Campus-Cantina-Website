      ...
      <div>
          <form id="registration" className="registration" method="POST">
              ...
              <fieldset className="login_fieldset-form2">
                  ...
                  <login_label htmlFor="username"> Name
                      <input id="username" className="login_input-field" type="text" placeholder="Name" required name="Name" />
                  </login_label>

                  <login_label htmlFor="email"> Email "@mail.sfsu.edu" </login_label>
                  <input className="login_input-field" id="email" type="email" placeholder="Email" required name="email ''@mail.sfsu.edu'' " />
